...
class DengSymMMIStripToSlotSimulation(Simulation):
    def __init__(self,
                 ...
                 opt_parameters=[],
                 catch_errors=False):
        Simulation.__init__(self, "DengMMIStripToSlot", working_dir="WD_DengMMIStripToSlot", catch_errors=catch_errors)
    ...
    def run(self, parameters):
        ...
        if self.parameter_changelog.changesExclude(opt_parameters): # Rebuild the simulation
            ...
            self.sim = mp.Simulation(resolution=resolution,
                                     ...
                                     geometry=[input_wg, dr_geometry, output_rail_top, output_rail_bottom],
                                     sources=sources,
...
if __name__ == "__main__":
    ...
    # Simulate our design    
    sim = DengSymMMIStripToSlotSimulation(taper_order=taper_order,
